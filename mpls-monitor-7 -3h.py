...
class MplsController(app_manager.RyuApp):
    ...
    csv_file = 'speed_data_metred-kbs-File7-tcp2hosts-reel.csv'
    ...
    def _packet_in_handler(self, ev):
        ...
        if dpid == "0000000000000001" and ethtype == 2048 :
            ...
            if in_port ==4 and dst == "00:00:00:00:00:02" :
                self.push_mpls(ev, out_port)
            elif in_port ==4 and dst == "00:00:00:00:00:03" :
                self.push_mpls(ev, out_port)
        ...
        if ethtype == 2048 and dpid == "0000000000000004":
            if in_port == 3  and dst == "00:00:00:00:00:01" :
                self.push_mpls(ev, out_port)
            elif in_port ==3 and dst == "00:00:00:00:00:02" :
                self.push_mpls(ev, out_port)
