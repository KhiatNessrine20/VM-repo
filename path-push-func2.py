...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def push_mpls(self, ev, out_port):
        ...
        pkt_mpls.add_protocol(ethernet.ethernet(ethertype=eth.ethertype,
        ...
        out = parser.OFPPacketOut(datapath=datapath, buffer_id=msg.buffer_id,in_port=in_port, actions=actions, data=pkt_mpls)
